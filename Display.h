...
int messageDisplayLength = strlen(messageDisplay);
int scrollPosition = 0;
unsigned long previousScrollMillis = 0;
const long scrollInterval = 100; // Adjust this value to control the scroll speed 
...
{0x00,0xFF,0x00,0xFF,0x00,0x00},	// 0xBA         Degree
